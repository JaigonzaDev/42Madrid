...
/*   Updated: 2025/07/03 17:16:51 by jaigonza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
 * The render_format() function determines 
 * how to render data based on the format 
 * specifier in the string (s) of the t_data structure. 
 * If the specifier is 'c', 's', or '%', 
 * it calls the render_char() function. 
 * Otherwise, it calls the render_num() 
 * function to handle numerical formats.
 */
...
/*
 * The check_format() function verifies if the 
 * format specifier in the string (s) 
